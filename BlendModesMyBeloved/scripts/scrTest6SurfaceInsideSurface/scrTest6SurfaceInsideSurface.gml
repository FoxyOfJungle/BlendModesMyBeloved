...
function BlendTest6() : BlendTestClass() constructor {
	...
	static Draw = function(_xx, _yy, _ww, _hh, _toggleFixIndex) {
		...
		surface_set_target(surface2);
			...
			gpu_set_blendmode_ext_sepalpha(bm_src_alpha, bm_inv_src_alpha, bm_one, bm_inv_src_alpha); // PMA blendmode
		...
		// Draw second surface
		gpu_set_blendmode_ext(bm_one, bm_inv_src_alpha); // ALWAYS USE THIS WHEN DRAWING THE SURFACE INSIDE SURFACE (application_surface is a surface too!)
